        ...
        <footer className="border-t border-brand-gray bg-white">
            <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-[1fr_auto] lg:px-8">
                <div>
                    ...
                    <p className="mt-4 max-w-2xl text-xs leading-6 text-brand-olive/75">ClaimDefender organizes available weather records and their source context. This demonstration uses fictional sample data and does not determine insurance coverage, establish physical damage or causation, replace an inspection, or provide legal or engineering advice.</p>
                </div>
