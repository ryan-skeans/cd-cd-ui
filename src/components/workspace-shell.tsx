    ...
    return (
        <div className="min-h-screen bg-brand-offWhite text-brand-olive lg:grid lg:grid-cols-[270px_minmax(0,1fr)]">
            <aside className="hidden min-h-screen bg-brand-olive p-6 text-white lg:block">
                <div className="sticky top-6"><div className="flex items-center justify-between"><BrandMark inverse /><DemoBadge inverse /></div><p className="mt-6 text-[10px] font-bold uppercase tracking-[0.16em] text-brand-lime">Demo Workspace</p><WorkspaceNavigation /><p className="mt-10 border-t border-white/10 pt-5 text-[11px] leading-relaxed text-white/45">Browser-local product demonstration. Not a claim system of record.</p></div>
            </aside>
            <div className="min-w-0">
                <header className="border-b border-brand-gray bg-white px-4 py-3 lg:hidden"><div className="flex items-center justify-between"><BrandMark /><details className="group relative"><summary className="grid h-10 w-10 cursor-pointer list-none place-items-center rounded-xl border border-brand-gray [&::-webkit-details-marker]:hidden"><Menu className="h-5 w-5" /><span className="sr-only">Open workspace navigation</span></summary><div className="absolute right-0 top-12 z-50 w-72 rounded-2xl border border-brand-gray bg-white p-3 shadow-xl"><div className="mb-2 flex items-center justify-between px-2"><span className="text-xs font-bold uppercase tracking-wider">Demo Workspace</span><DemoBadge /></div><WorkspaceNavigation mobile /></div></details></div></header>
